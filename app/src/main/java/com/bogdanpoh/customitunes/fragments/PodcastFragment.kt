...
class PodcastFragment() : Fragment() {
    ...
    private lateinit var podcastList: List<Podcast>

    constructor(podcastList: List<Podcast>) : this() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerAdapter.setupList(recyclerAdapter.podcastToMainModel(podcastList))
    }
}